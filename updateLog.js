...

  {
    ...
    "log": [
...

      {
        ...
        "log": [
          {
            "title": "생존 모드 순위표에 경과 시간이 잘못 표시되던 버그를 수정하였습니다.",
            "log": []
          },
          {
            "title": "무작위로 변경되어야 하는 값들이 페이지를 새로고침하기 전까지 변경되지 않던 버그를 수정하였습니다.",
            "log": [
              "이제 클래식 모드 35 이상의 스테이지에서 힌트 요소들이 새로고침을 하지 않아도 매번 랜덤한 개수만큼 등장합니다.",
              "이제 도전 모드의 초급02, 초급03, 초급04, 초급05, 초급06, 중급03, 중급05 맵의 힌트 요소들이 새로고침을 하지 않아도 매번 랜덤한 개수만큼 등장합니다.",
              "이제 생존 모드의 초기 시작점 및 맵의 힌트 요소와 아이템의 개수가 새로고침을 하지 않아도 매번 랜덤하게 조정됩니다."
            ]
          },
        ]
      },

      {
        ...
        "log": [
          {
            "title": "도전 모드에 신규 맵 [ 고급 06 ]을 추가하였습니다.",
            "log": []
          },
          {
            "title": "도전 모드의 일부 맵들의 난이도 표시를 변경하였습니다.",
            "log": [
              "중급 05, 중급 06 난이도 ⭐⭐⭐ → ⭐⭐",
              "고급 04 난이도 ⭐⭐⭐ → ⭐⭐⭐⭐",
              "난이도 표시만 변경하였을 뿐, 실제 난이도에는 변동이 없습니다."
            ]
          },
          {
            "title": "순위표 UI를 일부 변경하였습니다.",
...

  {
    ...
    "log": [

      {
        ...
        "log": [
          {
            "title": "힌트 모양을 표시할 때 나는 효과음과 아이템을 사용할 수 없을 때 나는 효과음이 변경되었습니다.",
            "log": []
          }
        ]
      }
...

  {
    ...
    "log": [

      {
        ...
        "log": [
          {
            "title": "크롬 브라우저에서 이모지가 원래 색이 아닌 글자 색으로 표시되던 현상을 수정하였습니다.",
            "log": []
          }
        ]
      }
