        ...
        "log": [
          {
            ...
            "log": [
              "형평성에 크게 어긋나는 버그이기 때문에 9월 17일 패치 이후 플레이 했던 모든 기록들에 대하여 해당 스테이지에서 획득 가능한 라이프보다 죽은 횟수가 더 많은 스테이지가 있을 경우, 해당 스테이지까지의 기록만 인정하여 기록을 변경할 예정입니다.",
              "해당 기록들을 모두 수정하는대로 수정된 결과를 다시 공지하도록 하겠습니다."
            ]
          },
          {
